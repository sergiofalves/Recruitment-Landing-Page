...
## 🔓 Open Access
I have made this source code public to support the research community. You are welcome to **fork, modify, and adapt** this template for your own projects or studies.

## 📄 License
This project is available under the **MIT License**. This means you are free to use, copy, and modify the software, provided that the original copyright notice and permission notice are included in any substantial portions of the material.
